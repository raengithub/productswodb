package com.self.test.application;
...
public class ApplicationConfig extends Application {
    ...
    public Set<Class<?>> getClasses() {
        ...
        resources.add(com.self.test.provider.MyJacksonJsonProvider.class);
        resources.add(com.self.test.resource.ProductResource.class);
